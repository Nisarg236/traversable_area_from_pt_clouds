...
def DownSample(pts, voxel_size=0.4):
...
def PlaneRegression(points, threshold=0.05, init_n=3, iter=1000):
...
def DetectMultiPlanes(points, min_ratio=0.1, threshold=0.01, iterations=1000):
